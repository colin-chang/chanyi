...
{
    class EditRoleViewModel : EditViewModel
    {
        public EditRoleViewModel(string id)
        {
            this.Id = id;
        ...
        {
            return this.Service.GetRoleById(this.Id);
        }
        ...
        public DelegateCommand<UIElement> SubmitCommand
        {
            get
            {
                ...
                {
                    var result = this.Service.UpdateRole(this.name, this.Description, this.Remark, this.Id);
