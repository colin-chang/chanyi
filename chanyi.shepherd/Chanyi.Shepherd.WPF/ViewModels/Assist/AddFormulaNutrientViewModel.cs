...
{
    class AddFormulaNutrientViewModel : AddViewModel
    {
        public AddFormulaNutrientViewModel(UIElement error)
        {
            this.errorControl = error;
            this.InitializeBindData();
        }

        public AddFormulaNutrientViewModel(bool withinInitilization)
        {
        }
        ...
        protected override void InitializeBindItem()
        {
            ...
            var pincipals = this.Service.GetEmployeeBind();
            this.UIDispatcher.Invoke(new Action(() =>
            {
                this.Principals.Add(new EmployeeBind { Name = defaultSelection });
                pincipals.ForEach(p => this.Principals.Add(p));
            }), null);
        }
        ...
        public DelegateCommand<UIElement> SubmitCommand
        {
            get
            {
                ...
                {
                    var result = this.Service.AddFormulaNutrient(this.Name, this.DailyGain.ToFloat(), this.CP.ToFloat(), this.DMI.ToFloat(), this.EE.ToFloat(), this.CF.ToFloat(), this.NFE.ToFloat(), this.Ash.ToFloat(), this.NDF.ToFloat(), this.ADF.ToFloat(), this.Starch.ToFloat(), this.Ga.ToFloat(), this.AllP.ToFloat(), this.Arg.ToFloat(), this.His.ToFloat(), this.Ile.ToFloat(), this.Leu.ToFloat(), this.Lys.ToFloat(), this.Met.ToFloat(), this.Cys.ToFloat(), this.Phe.ToFloat(), this.Tyr.ToFloat(), this.Thr.ToFloat(), this.Trp.ToFloat(), this.Val.ToFloat(), this.P.ToFloat(), this.Na.ToFloat(), this.Cl.ToFloat(), this.Mg.ToFloat(), this.K.ToFloat(), this.Fe.ToFloat(), this.Cu.ToFloat(), this.Mn.ToFloat(), this.Zn.ToFloat(), this.Se.ToFloat(), this.Carotene.ToFloat(), this.VE.ToFloat(), this.VB1.ToFloat(), this.VB2.ToFloat(), this.PantothenicAcid.ToFloat(), this.Niacin.ToFloat(), this.Biotin.ToFloat(), this.Folic.ToFloat(), this.Choline.ToFloat(), this.VB6.ToFloat(), this.VB12.ToFloat(), this.LinoleicAcid.ToFloat(), this.Salt.ToFloat(), this.PrincipalId, this.UserId, this.Remark);

                    if (!ValidateFailedServiceResult<string>(result))
                        return;
                    if (this.Continue2Add("标准添加成功"))
                        return;
        ...
        public string Title { get {return "新增营养标准"; } }
