...
{
    class EditStudsheepViewModel : EditViewModel
    {
        public EditStudsheepViewModel(string id)
        {
            this.Id = id;
        ...
        {
            //return this.Service.GetAssessStudsheep(new AssessStudsheepFilter { Id = this.Id }).FirstOrDefault();
            return this.Service.GetAssessStudsheepById(this.Id);
        }
        ...
        public DelegateCommand<UIElement> SubmitCommand
        {
            get
            {
                ...
                {
                    var result = this.Service.UpdateAssessStudsheep(float.Parse(this.MatingAbility), float.Parse(this.Weight), float.Parse(this.HabitusScore), (DateTime)this.AssessDate, this.PrincipalId, this.Remark, this.Id);
