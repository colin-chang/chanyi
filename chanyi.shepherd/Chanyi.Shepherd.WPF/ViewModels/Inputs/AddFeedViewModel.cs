...
{
    class AddFeedViewModel : AddViewModel
    {
        public AddFeedViewModel(UIElement error)
        {
            this.errorControl = error;
            this.InitializeBindData();
        }
        public AddFeedViewModel(bool withinInitilization) { }
        ...
        public DelegateCommand<UIElement> SubmitCommand
        {
            get
            {
                ...
                {
                    var result = this.Service.AddFeed(this.FeedNameId, this.TypeNameId, this.AreaId, this.Description, this.UserId, this.CP.ToFloat(), this.DMI.ToFloat(), this.EE.ToFloat(), this.CF.ToFloat(), this.NFE.ToFloat(), this.Ash.ToFloat(), this.NDF.ToFloat(), this.ADF.ToFloat(), this.Starch.ToFloat(), this.Ga.ToFloat(), this.Arg.ToFloat(), this.His.ToFloat(), this.Ile.ToFloat(), this.Leu.ToFloat(), this.Lys.ToFloat(), this.Met.ToFloat(), this.Cys.ToFloat(), this.Phe.ToFloat(), this.Tyr.ToFloat(), this.Thr.ToFloat(), this.Trp.ToFloat(), this.Val.ToFloat(), this.P.ToFloat(), this.Na.ToFloat(), this.Cl.ToFloat(), this.Mg.ToFloat(), this.K.ToFloat(), this.Fe.ToFloat(), this.Cu.ToFloat(), this.Mn.ToFloat(), this.Zn.ToFloat(), this.Se.ToFloat(), this.Carotene.ToFloat(), this.VE.ToFloat(), this.VB1.ToFloat(), this.VB2.ToFloat(), this.PantothenicAcid.ToFloat(), this.Niacin.ToFloat(), this.Biotin.ToFloat(), this.Folic.ToFloat(), this.Choline.ToFloat(), this.VB6.ToFloat(), this.VB12.ToFloat(), this.LinoleicAcid.ToFloat(), this.AllP.ToFloat());
                    this.errorControl = err;
                    if (!ValidateFailedServiceResult<string>(result))
                        return;
                    if (this.Continue2Add("新饲料添加成功"))
                        return;
        ...
        public DelegateCommand AddAreaName
        {
            get
            {
                return new DelegateCommand(() =>
                {
                    AddAreaWindow win = new AddAreaWindow();
                    ...
                    if (win.ShowDialog() == true)
                    {
                        ...
                        this.UIDispatcher.Invoke(new Action(() =>
                        {
                            ...
                            this.AreaNames.Add(new AreaBind { Name = defaultSelection });
                            areaNames.ForEach(a => this.AreaNames.Add(a));
                            this.AreaId = this.AreaNames.FirstOrDefault() == null ? null : this.AreaNames.FirstOrDefault().Id;
                        }), null);
                    }
                });
            }
        ...
        public DelegateCommand AddFeedName
        {
            get
            {
                return new DelegateCommand(() =>
                {
                    AddFeedNameWindow win = new AddFeedNameWindow();
                    win.Owner = CurrentWindow;
                    if (win.ShowDialog() == true)
                    {
                        var feedNames = this.Service.GetFeedNameBind();
                        this.UIDispatcher.Invoke(new Action(() =>
                        {
                            ...
                            this.FeedNames.Add(new FeedNameBind { Name = defaultSelection });
                            feedNames.ForEach(f => this.FeedNames.Add(f));
                            this.FeedNameId = this.FeedNames.FirstOrDefault() == null ? null : this.FeedNames.FirstOrDefault().Id;
                        }), null);
                    }
                });
            }
